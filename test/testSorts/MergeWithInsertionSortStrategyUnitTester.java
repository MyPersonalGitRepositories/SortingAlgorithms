...
import sorts.Item;
import sorts.MergeWithInsertionSortStrategy;

import static org.junit.Assert.assertTrue;

public class MergeWithInsertionSortStrategyUnitTester extends SortStrategyUnitTester{
    @BeforeClass
    public static void setSortStrategy(){
        mySorter.setCurrentSortStrategy(new MergeWithInsertionSortStrategy());
    }
