...
import sorts.Item;
import sorts.QuickWithInsertionSortStrategy;

import static org.junit.Assert.assertTrue;

public class QuickWithInsertionSortStrategyUnitTester extends SortStrategyUnitTester {

    @BeforeClass
    public static void setSortStrategy(){
        mySorter.setCurrentSortStrategy(new QuickWithInsertionSortStrategy());
    }
