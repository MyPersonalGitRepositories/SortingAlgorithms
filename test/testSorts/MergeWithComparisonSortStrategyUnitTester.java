...
import sorts.Item;
import sorts.MergeWithComparisonSortStrategy;

import static org.junit.Assert.assertTrue;

public class MergeWithComparisonSortStrategyUnitTester extends SortStrategyUnitTester {

    @BeforeClass
    public static void setSortStrategy(){
        mySorter.setCurrentSortStrategy(new MergeWithComparisonSortStrategy());
    }
