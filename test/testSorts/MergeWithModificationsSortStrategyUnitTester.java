...
import sorts.Item;
import sorts.MergeWithModificationsSortStrategy;

public class MergeWithModificationsSortStrategyUnitTester extends SortStrategyUnitTester {

    @BeforeClass
    public static void setSortStrategy(){
        mySorter.setCurrentSortStrategy(new MergeWithModificationsSortStrategy());
    }
