...
import sorts.Item;
import sorts.QuickWithDeykstraSortStrategy;

import static org.junit.Assert.assertTrue;

public class QuickWithDeykstraSortStrategyUnitTester extends SortStrategyUnitTester {

    @BeforeClass
    public static void setSortStrategy(){
        mySorter.setCurrentSortStrategy(new QuickWithDeykstraSortStrategy());
    }
